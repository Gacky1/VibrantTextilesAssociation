...
export function BuyerVerification(){const auth=useAuth();return <Shell title="Buyer verification" subtitle={`Your verification status is ${auth.buyerVerificationStatus || 'pending'}. VTA administrators will review your account before marketplace enquiries and quotations are enabled.`}><Tile to="/marketplace" title="Browse marketplace" text="You may continue exploring verified products while your account is reviewed." /></Shell>;}
